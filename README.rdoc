...
Version 0.3.0 of business_time gem has a bug that must be fixed to work properly. Detailed explanation is here[https://github.com/bokmann/business_time/issues#issue/4].
